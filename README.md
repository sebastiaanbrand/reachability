...
Our conclusions remain intact, except with regard to the smaller instances (i.e. < 0.1 sec reachability time). In the case the paper is accepted, we will of course make the necessary corrections in the final version.
...
We apologize to the reviewers for this mistake.
